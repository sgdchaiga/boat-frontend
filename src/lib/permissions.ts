...
export const PAGE_ACCESS_DEFS: PageAccessDef[] = [
  ...
  { page: "practice_my_work", label: "My Work", group: "Practice" },
  ...
  { page: "practice_document_requests", label: "Document Requests", group: "Practice" },
  { page: "practice_support", label: "Support Desk", group: "Practice" },
  ...
  { page: "practice_renewals", label: "Subscription Renewals", group: "Practice" },
  { page: "practice_profitability", label: "Engagement Profitability", group: "Practice" },
  { page: "practice_activity", label: "Activity History", group: "Practice" },
  { page: "practice_time_expenses", label: "Time & Expenses", group: "Practice" },
  { page: "practice_sales", label: "Sales & Proposals", group: "Practice" },
  { page: "practice_quality", label: "Quality & Client Experience", group: "Practice" },
  { page: "practice_capacity", label: "Staff Capacity", group: "Practice" },
  { page: "practice_client_portal", label: "Client Portal", group: "Practice" },
  { page: "practice_advanced", label: "Advanced Practice Controls", group: "Practice" },
  { page: "practice_integrations", label: "Practice Integrations", group: "Practice" },
  { page: "practice_mobile", label: "Practice Mobile", group: "Practice" },
  { page: "learning_centre", label: "Help & Learning Centre", group: "Practice" },
  ...
  { page: "school_rental_register", label: "School rental charges register", group: "Accounting" },
  { page: "school_rental_payments", label: "School rent collections", group: "Accounting" },
...
function roleDefaultAllows(permission: PermissionKey, roleKey: string): boolean {
  ...
  if (permission === "purchase_orders") return ["admin", "manager", "headteacher", "director"].includes(roleKey);
  if (permission === "bills") return ["admin", "manager", "accountant", "bursar", "headteacher", "director"].includes(roleKey);
