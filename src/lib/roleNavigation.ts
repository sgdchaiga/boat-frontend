...
function cashierNav(businessType: BusinessType | null | undefined): RoleNavLeaf[] {
  ...
  return [
    ...
    { name: "Cash collections", icon: Banknote, page: "reports_pos_cash_collections" },
...
function accountantNav(): RoleNavLeaf[] {
  return [
    ...
    { name: "POS income reconciliation", icon: Receipt, page: "accounting_pos_income_reconciliation" },
