...
import { canRunLocalSyncWorker, readLocalSyncStatus, writeLocalSyncStatus, type LocalSyncStatus } from "@/lib/localSyncStatus";
...
export { canRunLocalSyncWorker, readLocalSyncStatus, type LocalSyncStatus };
