...
export function Layout({ children, currentPage, pageState = {}, onNavigate, onBack, canGoBack = false }: LayoutProps) {
      ...
      return [
        ...
        { name: 'Data entry', icon: Plus, children: [
          ...
          { name: user?.sales_workflow === 'quick_sale' ? 'Record sale / POS' : 'Issue sales invoice', page: user?.sales_workflow === 'quick_sale' ? 'retail_pos' : 'retail_credit_invoices' },
           ...
           ...(user?.enable_inventory !== false ? [{ name: 'Cash stock purchase', page: 'purchases_bills', state: { cashPurchaseOpen: true } }] : []),
    ...
    () => [
      ...
      { name: 'Budget & Vote Book', icon: BookOpen, children: [
        { group: 'Planning', items: [
          { name: 'Budget Setup', page: SCHOOL_PAGE.voteBook, state: { voteBookTab: 'formulation' } },
          { name: 'Department Budgets', page: SCHOOL_PAGE.voteBook, state: { voteBookTab: 'formulation' } },
        ] },
        { group: 'Approval', items: [
          { name: 'Review & Approval', page: SCHOOL_PAGE.voteBook, state: { voteBookTab: 'formulation' } },
          { name: 'Approved Budget', page: SCHOOL_PAGE.voteBook, state: { voteBookTab: 'vote' } },
        ] },
        { group: 'Control', items: [
          { name: 'Commitments', page: SCHOOL_PAGE.voteBook, state: { voteBookTab: 'approvals' } },
          { name: 'Budget Adjustments', page: SCHOOL_PAGE.voteBook, state: { voteBookTab: 'transfers' } },
          { name: 'Spending Controls', page: SCHOOL_PAGE.voteBook, state: { voteBookTab: 'controls' } },
        ] },
        { group: 'Reporting', items: [
          { name: 'Budget Performance', page: 'reports_budget_variance' },
        ] },
      ] },
      { name: 'Intelligence', icon: Lightbulb, page: 'industry_intelligence' },
      {
  ...
  const professionalSchoolNavigation: NavItem[] = [
    ...
    { name: 'Finance', icon: Landmark, children: [
      ...
      { group: 'Spend', items: [
        ...
        ...(generalBusinessCashbookEnabled ? [{ name: 'Petty Cash', page: 'school_cashbook_register' }] : []),
        { name: 'Supplier Payments', page: 'purchases_payments' },
        { name: 'Staff Advances', page: 'payroll_loans' },
      ] },
    ...
    { name: 'Admin', icon: Settings, children: [
      ...
      ...(canUseAdvancedAccounting ? [{ group: 'Advanced accounting', items: [
        ...
        { name: 'General ledger', page: 'accounting_gl' },
        { name: 'Trial balance', page: 'accounting_trial' },
        { name: 'Financial statements', page: 'accounting_income' },
  ...
  const mainNavigation: NavItem[] = (() => {
    const navigation = businessType !== 'accounting_practice' && enableAssetVerification
      ...
      : baseNavigation;
    if (user?.isSuperAdmin === true && user.enable_control_centre === true) {
