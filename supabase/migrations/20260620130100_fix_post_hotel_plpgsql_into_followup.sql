-- Follow-up for databases that already applied 20260620120000 before scalar/INTO fixes.
-- ERROR 42P01 relation "v_allowed" / "v_smart" / etc.: avoid `SELECT ... INTO` for scalars;
-- load stay row via `FOR ... IN SELECT ... LOOP` + `v_stay_found` instead of `INTO st`.
